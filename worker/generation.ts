...
export async function generate(payload: unknown, preview: boolean, apiKey: string, signal: AbortSignal, callbacks: StreamingReplyCallbacks | null, measurements?: ReturnType<typeof createGenerationMeasurements>, manifestationEnabled = false) {
  const llm: LlmRequestContext = { manifestationEnabled, apiKey, signal, warmup: false, onFallback: () => {}, runtime: {
