...
export const runtimeConfig = Object.freeze({
  worldMutationEnabled: mode === 'local' && import.meta.env.VITE_WORLD_MUTATION_ENABLED === 'true' && import.meta.env.VITE_MANIFESTATION_ENABLED !== 'true',
  manifestationEnabled: import.meta.env.VITE_MANIFESTATION_ENABLED === 'true',
