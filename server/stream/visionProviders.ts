...
async function postJson(
  ...
  try {
    ...
    throw new StreamVisionError('connection', 'Vision request failed to connect.', {
      cause: error,
    });
  }
    ...
    messages: [
      { role: 'system', content: request.instruction },
      {
        ...
        content: [
          ...
          { type: 'image_url', image_url: { url: dataUrl(request.beforeImage) } },
          { type: 'text', text: 'AFTER frame:' },
          { type: 'image_url', image_url: { url: dataUrl(request.afterImage) } },
        ],
      },
    ],
    response_format: {
...
const groqVisionProvider: StreamVisionProvider = {
  ...
  usdPerMillionTokens: { input: 0.11, output: 0.34 },
        ...
        contents: [
          {
            ...
            parts: [
              ...
              { text: 'AFTER frame:' },
              {
                inlineData: {
                  mimeType: 'image/jpeg',
                  data: request.afterImage.toString('base64'),
                },
              },
            ],
          },
