...
const mf=new Miniflare(convertV4MiniflareOptions({port:8892,host:'127.0.0.1',workers:[{name:'shared-preview',modules:true,script:bundle.outputFiles[0].text,compatibilityDate:'2026-09-07',compatibilityFlags:['nodejs_compat'],durableObjects:{USAGE:{className:'PublicUsage',useSQLite:true},WORLD_ROOMS:{className:'WorldRoom',useSQLite:true}},bindings:{COOKIE_SECRET:'local-shared-preview-fixture-key',ADMIN_SECRET:'local-shared-preview-fixture-key',SHARED_WORLD_ENABLED:'true',GENERATION_ENABLED:'false',REQUIRE_PREVIEW_ACCESS:'false',PUBLIC_BASE_PATH:'/staging'},r2Buckets:['VISUAL_ASSETS'],serviceBindings:{ASSETS:async request=>{
